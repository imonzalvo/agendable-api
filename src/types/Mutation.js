  ...
  definition(t) {
    ...
    t.field('updateBranch', {
      ...
      args: {
        ...
        description: stringArg(),
        image: stringArg(),
        servicesId: intArg({ nullable: true, list: true }),
      },
    ...
    t.field('createService', {
      ...
      args: {
        ...
        duration: intArg(),
        description: stringArg(),
        branchesId: intArg({ list: true, nullable: false }),
      },
    ...
    t.field('createEmployee', {
      ...
      args: {
        ...
        phone: stringArg(),
        branchesId: intArg({ list: true, nullable: true }),
        servicesId: intArg({ list: true, nullable: true }),
      },
    ...
    t.field('createBooking', {
      ...
      args: {
        ...
        status: stringArg(),
        clientId: intArg({ nullable: true }),
        branchId: intArg({ nullable: false }),
        servicesId: intArg({ list: true, nullable: false }),
        employeeId: intArg({ nullable: false }),
    ...
    t.field('updateBooking', {
      ...
      args: {
        ...
        status: stringArg(),
        clientId: intArg({ nullable: true }),
        branchId: intArg({ nullable: true }),
        servicesId: intArg({ list: true, nullable: true }),
        employeeId: intArg({ nullable: true }),
        clientEmail: stringArg({ nullable: true }),
        clientPhone: stringArg({ nullable: true }),
        clientName: stringArg({ nullable: true }),
        clientFamilyName: stringArg({ nullable: true }),
